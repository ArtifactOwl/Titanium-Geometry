...
const colors = [
  "Black","Aged Steel","Aged Bronze","Aged Brass","Aged Gold",
  "Yellow Gold","Copper","Rose Gold","Steel","Silver",
];
      ...
      <div>
        <a href="/images/necklace-color-chart.jpg" target="_blank" rel="noopener noreferrer">
          <img
            ...
            style={{ width: "200px", height: "auto", borderRadius: 6, border: "1px solid #ccc", cursor: "zoom-in" }}
          />
        </a>
        <p style={{ fontSize: "0.85rem", color: "#555" }}>Click image to view full-size color chart</p>
      </div>
    </div>
  );
}
